...
void tournee_2_optimisation_plus_proche_voisin(MatriceDistance, Permutation permutation_courante,
                                               Permutation permutation_resultat);

void tournee_2_optimisation_marche_aleatoire(MatriceDistance, Permutation permutation_courante,
                                             Permutation permutation_resultat);
